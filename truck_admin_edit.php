...
$updateId = $_GET['update_id'];
        $sql = "SELECT * FROM truck WHERE truck_id = '".$updateId."' ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $sql1 = "UPDATE truck SET truck_id = '".$_POST['truck_id']."', truck_detail = '".$_POST["truck_detail"]."',
                    truck_route = '".$_POST['truck_route']."',emp_id = '".$_POST['emp_id']."'
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">แก้ไขข้อมูลรถส่งสินค้า</h1>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="p-5">
                                            ...
                                            <form class="user" action="truck_admin_edit.php?update_id=<?php echo $updateId ?>" method="post" name="myForm">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg"
                                                        id="truck_id" name="truck_id" placeholder="ป้ายทะเบียนรถ" value="<?php echo $arr1['truck_id'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <textarea class="form-control form-control-lg"
                                                        id="truck_detail" name="truck_detail" placeholder="รายละเอียดรถ" style="resize: none; height: 130px;"><?php echo $arr1['truck_detail'] ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <textarea class="form-control form-control-lg"
                                                        id="truck_route" name="truck_route" placeholder="เส้นทางที่รถวิ่ง" style="resize: none; height: 130px;"><?php echo $arr1['truck_route'] ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                <?php
                                                    ...
                                                    while($arr2 = mysqli_fetch_array($result)){
                                                        echo "<option ".($arr1["emp_id"]==$arr2["emp_id"]?"SELECTED":"")." value='".$arr2['emp_id']."'>".$arr2['emp_name'],' ',$arr2['emp_sname']."</option>";
                                                    }
                                                    echo "</select>"."<br><br>";
                                                ?>
                                                </div>
