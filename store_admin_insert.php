...
if(isset($_POST['submit'])){
    $sql = "SELECT st_id FROM store ORDER BY st_id DESC LIMIT 1";
    $result1 = mysqli_query($conn, $sql);
    $st_id = "ST" . str_pad((int)(substr(mysqli_fetch_assoc($result1)["st_id"] ?? "ST000", 2)) + 1, 3, "0", STR_PAD_LEFT);
    ...
    $sql1 = "INSERT INTO store(st_id,st_name,st_address,province,amphur,district,postcode,st_phone)
    VALUES ('$st_id','$st_name','$st_address','$province','$amphur','$district','$postcode','$st_phone')";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="p-5">
                                            ...
                                            <form class="user" action="store_admin_insert.php" method="post" name="myForm">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg"
                                                        id="st_name" name="st_name" placeholder="ชื่อร้านค้า">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg" 
                                                        id="st_address" name="st_address" placeholder="รายละเอียดที่อยู่">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg" 
                                                        id="st_phone" name="st_phone" placeholder="เบอร์โทรศัพท์">
                                                </div>
