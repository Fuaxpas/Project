                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">ข้อมูลพนักงาน</h1>
                                            </div>
                                            <form class="user" action="employee_admin_edit.php?update_id=<?php echo $updateId ?>" method="post" name="myForm">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg"
                                                        id="emp_id" name="emp_id" placeholder="ชื่อผู้ใช้" value="<?php echo $arr1['emp_id'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg"
                                                        id="emp_psw" name="emp_psw" placeholder="รหัสผ่าน" value="<?php echo $arr1['emp_psw'] ?>">
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <input type="text" class="form-control form-control-lg" 
                                                        id="emp_name" name="emp_name" placeholder="ชื่อ" value="<?php echo $arr1['emp_name'] ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-lg" 
                                                        id="emp_sname" name="emp_sname" placeholder="นามสกุล" value="<?php echo $arr1['emp_sname'] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <input type="date" class="form-control form-control-lg" id="emp_birth" name="emp_birth" value="<?php echo $arr1['emp_birth'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg"
                                                    id="emp_phone" name="emp_phone" placeholder="เบอร์โทรศัพท์" value="<?php echo $arr1['emp_phone'] ?>">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg"
                                                    id="qualification" name="qualification" placeholder="คุณสมบัติ" value="<?php echo $arr1['qualification'] ?>">
                                                </div>
                                                <div class="form-group">
